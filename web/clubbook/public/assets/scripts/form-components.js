var FormComponents = function () {
    ...
    var handleMultiSelect = function () {
        ...
        $('#select_venue').multiSelect({
            selectableHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='" + window.MESSAGES.search + "'>",
            selectionHeader: "<input type='text' class='form-control search-input' autocomplete='off' placeholder='" + window.MESSAGES.search + "'>",
