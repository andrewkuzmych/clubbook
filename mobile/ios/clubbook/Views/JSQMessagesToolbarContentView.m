...
@property (weak, nonatomic) IBOutlet UIView *middleBarButtonConteinerView;
...
- (void)awakeFromNib
{
    ...
    [self.middleBarButtonConteinerView setTranslatesAutoresizingMaskIntoConstraints:NO];
...
- (void)dealloc
{
    ...
    _middleBarButtonConteinerView = nil;
}
...
- (void)setBackgroundColor:(UIColor *)backgroundColor
{
    ...
    self.middleBarButtonConteinerView.backgroundColor = backgroundColor;
}
...
- (void)setMiddleBarButtonItem:(UIButton *)middleBarButtonItem
{
    ...
    if (CGRectEqualToRect(middleBarButtonItem.frame, CGRectZero)) {
        middleBarButtonItem.frame = CGRectMake(0.0f,
                                             0.0f,
                                             CGRectGetWidth(self.leftBarButtonContainerView.frame),
                                             CGRectGetHeight(self.leftBarButtonContainerView.frame));
    }
    
    self.middleBarButtonConteinerView.hidden = NO;
    // self.leftHorizontalSpacingConstraint.constant = kJSQMessagesToolbarContentViewHorizontalSpacingDefault;
    //self.leftBarButtonItemWidth = CGRectGetWidth(middleBarButtonItem.frame);
    
    [self.middleBarButtonConteinerView addSubview:middleBarButtonItem];
    [self.middleBarButtonConteinerView jsq_pinAllEdgesOfSubview:middleBarButtonItem];
    [self setNeedsUpdateConstraints];
